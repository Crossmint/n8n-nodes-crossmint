...
export const checkoutFields: INodeProperties[] = [
	...
	},
	{
		...
		name: 'platform',
		type: 'options',
		displayOptions: { show: { operation: ['findProduct'] } },
		options: [
	...
	// ---- Purchase Product fields (Step 2: Submit Transaction)
	{
		...
		type: 'string',
		displayOptions: { show: { operation: ['purchaseProduct'] } },
		default: '',
	...
	},
	{
		...
		type: 'string',
		displayOptions: { show: { operation: ['findProduct'], platform: ['amazon'] } },
		default: '',
	...
	},
	{
		...
		name: 'productIdentifier',
		type: 'string',
		displayOptions: { show: { operation: ['findProduct'], platform: ['shopify'] } },
		default: '',
	...
	},
	{
		...
		name: 'paymentMethod',
		type: 'options',
		displayOptions: { show: { operation: ['findProduct'], environment: ['staging'] } },
		options: [
			{ name: 'Arbitrum Sepolia', value: 'arbitrum-sepolia', description: 'Arbitrum testnet' },
			{ name: 'Base Sepolia', value: 'base-sepolia', description: 'Base testnet' },
			{ name: 'Ethereum Sepolia', value: 'ethereum-sepolia', description: 'Ethereum testnet' },
	...
	},
	{
		...
		name: 'paymentMethod',
		type: 'options',
		displayOptions: { show: { operation: ['findProduct'], environment: ['production'] } },
		options: [
			{ name: 'Arbitrum', value: 'arbitrum', description: 'Arbitrum network' },
			{ name: 'Base', value: 'base', description: 'Base network' },
			{ name: 'Ethereum', value: 'ethereum', description: 'Ethereum mainnet' },
