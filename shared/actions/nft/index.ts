...
export const nftFields: INodeProperties[] = [
	...
	// ---- Get NFTs from Wallet fields
	{
		...
		displayOptions: { show: { operation: ['getNFTsFromWallet'] } },
	...
	// ---- Mint NFT fields
	{
		...
		name: 'collectionId',
		type: 'string',
		displayOptions: { show: { operation: ['mintNFT'] } },
		default: '',
	...
	},
	{
		...
		name: 'nftName',
		type: 'string',
		displayOptions: { show: { operation: ['mintNFT'], metadataType: ['object'] } },
		default: '',
	...
	},
	{
		...
		name: 'metadataUrl',
		type: 'string',
		displayOptions: { show: { operation: ['mintNFT'], metadataType: ['url'] } },
		default: '',
	...
	},
	{
		...
		name: 'templateId',
		type: 'string',
		displayOptions: { show: { operation: ['mintNFT'], metadataType: ['template'] } },
		default: '',
